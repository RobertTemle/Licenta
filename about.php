			...
			<div class="row row--grid">
				...
				<div class="col-12 col-xl-11">
					<div class="main__title main__title--page">
						<h1>Cararo – Car rental</h1>

						<p>Cararo is a company built around trust, seriosity and hard work. With a good and diverse selection of <a href="catalog.php">cars</a> we are able to reach and offer you the best offers there are. </p>
						...
						<br>
						<p>You can shoot us an e-mail by clicking <a href="contact.php">here.</a></p>
					</div>
				</div>
				<!-- end title -->
			</div>
			...
			<div class="row row--grid">
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<p class="step__text">It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures.</p>
					</div>
				</div>
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Choose your desired Car</h3>
				...
				<div class="col-12 col-lg-4">
					<div class="step">
						...
						<h3 class="step__title">Pick up your Car</h3>
						<p class="step__text">The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row row--grid">
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="team">
						<div class="team__img">
							<img src="img/team/TR.jpg" alt="">
						</div>
						<h3 class="team__name">Temle Robert</h3>
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="team">
						<div class="team__img">
							<img src="img/team/RR.jpg" alt="">
						</div>
						<h3 class="team__name">Radha Rathore</h3>
							...
							<ul class="splide__list">
								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/paypal.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/eaton.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/blacknight.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/citydogs.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/evelie.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/netcore.png" alt="">
									</a>
								</li>

								<li class="splide__slide">
									<a href="#" class="partners__img">
										<img src="img/partners/nomad.png" alt="">
									</a>
								</li>
							</ul>
						</div>
