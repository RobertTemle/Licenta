...
<body>
	...
	<main class="main">
		<div class="container">
			<button class="btn btn-primary my-5"><a href="car-search.php" class="text-light">Back to Search Bar</a></button>
			...
			<table class="table table-dark">
				...
				<tbody>
					...
					if (empty($_POST["Brand"]) AND empty($_POST["CarName"])) {
					...
					if (empty($_POST["CarName"])) {
						...
						$sql = "SELECT * FROM cars WHERE Brand = '$Brand' or CarName = '$CarName'";
					}
