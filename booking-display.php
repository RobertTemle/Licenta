...
<body>
	...
	<main class="main">
		...
		<div class="container">
			...
			<button class="btn btn-primary my-5"><a href="booking-add.php" class="text-light"> Add Booking</a></button>

			<button class="btn btn-primary my-5"><a href="booking-search.php" class="text-light"> Search Booking</a></button>
