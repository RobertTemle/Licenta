					...
					<div class="filter-wrap">
						...
						<div class="collapse filter-wrap__content" id="collapseFilter">
							...
							<div class="filter filter--left filter--sticky">
								<form method="post" action="catalog-search.php">
									<h4 class="filter__title">Caută <button type="button"><a href="catalog-logged.php">Show all cars</a></button></h4>
			  				...
			  				<div class="col-12 col-md-6">
									<div class="car">
										...
										<div class="car__title">
											<h3 class="car__name"><a href="car-details.php?CarId='.$CarId.'">'.$Brand.' '.$CarName.'</a></h3>
										...
										<div class="car__footer">
											...
											<a href="car-details.php?CarId='.$CarId.'" class="car__more"><span>Rent now</span></a>
										</div>
									</div>
								</div>
								';
