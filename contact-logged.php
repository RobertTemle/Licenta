	...
	<main class="main">
		<div class="container">
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb">
						<li class="breadcrumb__item"><a href="index.html">Acasa</a></li>
			...
			<div class="row row--grid">
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="sign__group">
									<input type="text" name="name" class="sign__input" placeholder="Nume">
								</div>
							</div>

							<div class="col-12 col-md-6">
								<div class="sign__group">
									<input type="text" name="email" class="sign__input" placeholder="E-mail">
								</div>
							</div>

							<div class="col-12">
								<div class="sign__group">
									<input type="text" name="subject" class="sign__input" placeholder="Subiect">
								</div>
							</div>

							<div class="col-12">
								<div class="sign__group">
									<textarea name="text" class="sign__textarea" placeholder="Mesajul dumneavoastră"></textarea>
								</div>
							</div>

							<div class="col-12 col-xl-3">
								<a href="#"><button type="button" class="sign__btn"><span>Trimite</span></button></a>
							</div>
						</div>
					</form>	
				</div>
				...
				<div class="col-12 col-md-6 col-lg-5 col-xl-4">
					<div class="main__title main__title--sidebar">
						<h2>Info</h2>
						<p>Vom răspunde mesajului în 2-3 zile lucrătoare.</p>
					</div>
					<ul class="contacts__list">
						<li><a href="tel:88002345678">8 800 234 56 78</a></li>
						<li><a href="mailto:support@waydex.com">support@cararo.com</a></li>
						<li><a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1130.14636307049!2d23.575475688532936!3d47.64641813291494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4737dc0d6362d3cf%3A0x83d8b0fe0662c247!2sBulevardul%20Republicii%2062%2C%20Baia%20Mare%20430231!5e0!3m2!1sen!2sro!4v1655638278562!5m2!1sen!2sro" class="open-map">Bulevardul Republicii, Numarul 62, Baia-Mare</a></li>
					</ul>
