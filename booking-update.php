...
if (isset($_POST['submit'])) {
	...
	$sql = "UPDATE rezervari set IdRezervare = $IdRezervare, userID = '$userID', CarId = '$CarId', Name = '$Name', phoneNum = '$phoneNum', DelAddress = '$DelAddress', DelDate = '$DelDate', ReturnAddress = '$ReturnAddress', ReturnDate = '$ReturnDate', Status = '$Status' WHERE IdRezervare = $IdRezervare ";
	...
	<div class="container my-5">
		...
		<form method="post">
			...
			<div class="form-group">
    			<label>User ID</label>
    			<input type="int" class="form-control"  placeholder="ID Cannot Be Changed" name="userID"  value="<?php echo $userID?>">
  			</div>

  			<div class="form-group">
			    <label>Car ID</label>
			    <input type="int" class="form-control"  placeholder="Change Car ID" name="CarId" value="<?php echo $CarId?>">
  			</div>
  			...
  			<div class="form-group">
			    <label>Status</label>
			    <input type="text" class="form-control"  placeholder="Change Booking Status" name="Status" value="<?php echo $Status?>">
  			</div>
