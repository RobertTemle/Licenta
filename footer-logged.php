		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
					...
					<p class="footer__tagline">Search for cheap rental cars in Romania. <br>With a diverse fleet of 19,000 vehicles, Cararo <br> offers its consumers an attractive and fun selection.</p>
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-2 order-xl-3 offset-md-2 offset-lg-0">
					...
					<div class="footer__nav">
						...
						<a href="catalog-logged.php">Car Catalogue</a>
						<a href="contact-logged.php">Contact Us</a>
					</div>
				</div>
				...
				<div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-md-3 order-lg-1 order-xl-2">
					<div class="row">
						<div class="col-12">
							<h6 class="footer__title">Avem parcări disponibile în: </h6>
						</div>

						<div class="col-6">
							<div class="footer__nav">
								<a href="catalog-logged.php">Baia-Mare</a>
								<a href="catalog-logged.php">Cluj-Napoca</a>
								<a href="catalog-logged.php">Timișoara</a>
								<a href="catalog-logged.php">Brașov</a>
							</div>
						</div>

						<div class="col-6">
							<div class="footer__nav">
								<a href="catalog-logged.php">Galați</a>
								<a href="catalog-logged.php">București</a>
								<a href="catalog-logged.php">Satu-Mare</a>
								<a href="catalog-logged.php">Arad</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-md-4 order-lg-3 order-xl-4">
					...
					<div class="footer__nav">
						<a href="faq-logged.php">Help center</a>
						<a href="privacy-logged.php">Privacy policy</a>
						<a href="privacy-logged.php">Terms & conditions</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© Cararo, 2022. Created by <a href="https://twitter.com/Jobert_37" target="_blank"> Temle Robert</a>.</small>
					</div>
				</div>
			</div>
		</div>
