...
if (isset($_POST['submit'])) {
	...
	$sql = "UPDATE users set userId = $userId, Name = '$Name', Username = '$Username', Password = '$Password', UserType = '$UserType', Email = '$Email' WHERE UserId = $userId ";
		...
		<form method="post">
			...
			<div class="form-group">
  			...
  			<div class="form-group">
			    ...
			    <input type="text" class="form-control"  placeholder="Enter changed password" name="Password" value="<?php echo $Password?>">
  			</div>

  			<div class="form-group">
			    <label>User Type</label>
			    <input type="text" class="form-control"  placeholder="Change User Type" name="Type" value="<?php echo $UserType?>">
  			</div>
